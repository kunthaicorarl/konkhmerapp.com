...
<div>
    ...
    <div style="background:#ef1313;padding: 15px;padding-bottom: 9px;padding-top: 9px;">
        ...
        <div class="search">
            ...
            <form name="mySearch">
                <input type="text" ng-model="filterText" ng-keyup="searchMovie(vm.filterText)" ng-model="q" class="search_field _field" id="search_query" autocomplete="off" autocorrect="off" autocapitalize="off" spellcheck="false" placeholder="Search">
            </form>
